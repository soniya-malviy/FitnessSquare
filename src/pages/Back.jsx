...
import back4 from "../assets/back4.mp4";
...
const BackWorkout = () => {
  ...
  return (
    <div className="p-8 bg-black text-white h-screen">
      <h2 className="text-3xl font-bold text-center mb-6">Back Workouts</h2>
      <p className="text-center text-gray-600 mb-8">
        Strengthen your back body with these effective exercises.
      </p>
